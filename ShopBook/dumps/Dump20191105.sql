...
CREATE TABLE `posts` (
  ...
  `SKU_CLR_CODE` varchar(32) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column SKU_COLOR_TO_POST created as default foreign key column for foreign key "SKU_COLOR_TO_POST"',
  ...
  KEY `SKU_COLOR_TO_POST` (`SKU_CLR_CODE`),
  ...
  CONSTRAINT `SKU_COLOR_TO_POST` FOREIGN KEY (`SKU_CLR_CODE`) REFERENCES `sku_colors` (`SKU_CLR_CODE`),
...
INSERT INTO `shops` VALUES ('EG0000001','Shop Name.',NULL,NULL,NULL,'',NULL,NULL,'Egypt','1111111\n','/home/mfayed/Desktop/MyShop/shopData/rightImage.jpeg','/home/mfayed/Desktop/MyShop/shopData/logo.jpeg','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N','2019-08-05 22:46:54',2,1,'EG',NULL,NULL),('EG0000003','BBBBBBBBBB',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'000000000\n000000000\n000000000',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Y','2019-09-01 00:00:00',NULL,NULL,NULL,'EG0000001',NULL),('EG0000004','AAAA',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'AAAAAAA\n11111111\nAAAAAAA',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Y','2019-09-18 10:49:21',NULL,NULL,NULL,'EG0000001',NULL);
...
CREATE TABLE `sku_colors` (
  ...
  `AVAILABLE` varchar(1) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column AVAILABLE created from UML attribute "available" in UML class "sku color"',
  `RATE` int(5) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column RATE created from UML attribute "rate" in UML class "sku color"',
...
CREATE TABLE `sku_images` (
  ...
  `IMG_NAME` varchar(50) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column IMG__NAME created from UML attribute "img  name" in UML class "sku image"',
  `IMG_SEQ` int(1) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column IMG_SEQ created from UML attribute "img seq" in UML class "sku image"',
  `IMG_TYPE` varchar(20) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column IMG_TYPE created from UML attribute "img type" in UML class "sku image"',
  `NOTES` varchar(500) DEFAULT NULL,
  `LAST_MODIFIED` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'UML to Offline Database Transform: Column LAST_MODIFIED created from UML attribute "last modified" in UML class "sku image"',
  PRIMARY KEY (`SKU_IMG_CODE`),
  KEY `SKU_TO_SKU_IMAGE` (`SKU_CODE`),
  KEY `SKU_IMAGES_INDEX` (`SKU_IMG_CODE`),
  CONSTRAINT `SKU_TO_SKU_IMAGE` FOREIGN KEY (`SKU_CODE`) REFERENCES `skus` (`SKU_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='UML to Offline Database Transform: Table SKU_IMAGES created from UML class "sku image"\r\nUML to Offline Database Transform: Primary key constraint PRIMARY created by default\r\nUML to Offline Database Transform: Foreign key constraint SKU_TO_SKU_IMAGE created for UML association "sku to sku image"';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sku_size_colors` (
  ...
  KEY `SKU_CLR_TO_SKU_SZ_CLR` (`SKU_CLR_CODE`),
  KEY `SKU_SZ_TO_SKU_SZ_CLR` (`SKU_SIZE_CODE`),
  KEY `SKU_SIZE_COLORS_INDEX` (`SKU_SZ_CLR_CODE`),
  CONSTRAINT `SKU_CLR_TO_SKU_SZ_CLR` FOREIGN KEY (`SKU_CLR_CODE`) REFERENCES `sku_colors` (`SKU_CLR_CODE`),
...
--
-- Table structure for table `sku_sz_clr_images`
--

DROP TABLE IF EXISTS `sku_sz_clr_images`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sku_sz_clr_images` (
  ...
  `NOTES` varchar(500) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column NOTES created from UML attribute "notes" in UML class "sku sz clr image"',
  `LAST_MODIFIED` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`SKU_SZ_CLR_IMG_CODE`),
  KEY `SKU_IMGS_TO_SZ_CLR_IMGS` (`SKU_IMG_CODE`),
  KEY `SKU_SZ_CLR_TO_SKU_SZ_CLR_IMG` (`SKU_SZ_CLR_CODE`),
  KEY `SKU_SZ_CLR_IMAGES_INDEX` (`SKU_SZ_CLR_IMG_CODE`),
  CONSTRAINT `SKU_IMGS_TO_SZ_CLR_IMGS` FOREIGN KEY (`SKU_IMG_CODE`) REFERENCES `sku_images` (`SKU_IMG_CODE`),
  CONSTRAINT `SKU_SZ_CLR_TO_SKU_SZ_CLR_IMG` FOREIGN KEY (`SKU_SZ_CLR_CODE`) REFERENCES `sku_size_colors` (`SKU_SZ_CLR_CODE`)
...
--
-- Dumping data for table `sku_sz_clr_images`
--

LOCK TABLES `sku_sz_clr_images` WRITE;
/*!40000 ALTER TABLE `sku_sz_clr_images` DISABLE KEYS */;
/*!40000 ALTER TABLE `sku_sz_clr_images` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `skus` (
  ...
  `SKU_NAME` varchar(200) DEFAULT NULL COMMENT 'UML to Offline Database Transform: Column SKU_NAME created from UML attribute "sku name" in UML class "sku"',
...
INSERT INTO `skus` VALUES ('10','CatTwo-SKU-1','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00020002',NULL,NULL,'F00001',NULL,NULL,'2019-11-05 14:09:31',NULL,'Y'),('101','CatOne-SKU-1','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,'F00001',NULL,NULL,'2019-11-05 14:22:01',NULL,'Y'),('12','CatOne-SKU-2','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,'F00002',NULL,NULL,'2019-11-05 14:22:43',NULL,'Y'),('13','CatThree-SKU-3','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,'F00003',NULL,NULL,'2019-11-05 14:34:25',NULL,'Y'),('14','zzzzzz','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,'F00001',NULL,NULL,'2019-11-05 17:10:29',NULL,'Y'),('15','CatOne-SKU-5','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,NULL,NULL,NULL,'2019-11-05 17:16:47',NULL,'Y'),('16','CatOne-SKU-6','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00010001',NULL,NULL,NULL,NULL,NULL,'2019-11-05 19:30:46',NULL,'Y'),('22','CatTwo-SKU-2','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00020002',NULL,NULL,'F00002',NULL,NULL,'2019-11-05 14:10:21',NULL,'Y'),('23','CatTwo-SKU-3','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00020002',NULL,NULL,'F00003',NULL,NULL,'2019-11-05 14:37:24',NULL,'Y'),('24','CatTwo-SKU-4','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00020002',NULL,NULL,'F00003',NULL,NULL,'2019-11-05 14:43:44',NULL,'Y'),('25','CatTwo-SKU-5','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00020002',NULL,NULL,'F00002',NULL,NULL,'2019-11-05 17:44:44',NULL,'Y'),('31','CatThree-SKU-3','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00030003',NULL,NULL,'F00002',NULL,NULL,'2019-11-05 19:31:25',NULL,'Y'),('32','CatThree-SKU-2','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00030003',NULL,NULL,'F00004',NULL,NULL,'2019-11-05 19:32:09',NULL,'Y'),('40','CatFour-SKU-1','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00040004',NULL,NULL,'F00004',NULL,NULL,'2019-11-05 14:14:48',NULL,'Y'),('42','CatFour-SKU-2','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00040004',NULL,NULL,'F00003',NULL,NULL,'2019-11-05 14:15:42',NULL,'Y'),('43','CatFour-SKU-3','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00040004',NULL,NULL,'F00003',NULL,NULL,'2019-11-05 19:15:38',NULL,'Y'),('60','CatSix-SKU-1','Y','N',NULL,0,NULL,'N','N',NULL,'EG0000001G00060006',NULL,NULL,'F00002',NULL,NULL,'2019-11-05 14:18:50',NULL,'Y');
...
-- Dump completed on 2019-11-05 19:35:20
