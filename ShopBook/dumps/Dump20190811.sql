...
INSERT INTO `cat_mnf_brnd_mdl_yers` VALUES ('C0001B00001F00001M000000011930',NULL,'2019-08-02 18:25:47','B00001','C0001','F00001','M00000001',1930);
...
INSERT INTO `cat_size_classes` VALUES ('C0001Z01','Z01','C0001',NULL);
...
INSERT INTO `categories` VALUES ('C0000','Reserved','n/a',NULL,NULL,NULL),('C0001','Category One',NULL,'2019-08-02 18:07:36','D:\\MyShop\\Categories\\190802_182311.jpeg','.jpeg'),('C0002','category Two',NULL,'2019-08-02 18:23:22','D:\\MyShop\\Categories\\190802_182352.jpeg','.jpeg'),('C0003','gdhjdhdhfdfhdfhd',NULL,'2019-08-08 14:12:44','D:\\MyShop\\Categories\\190808_141254.jpeg','.jpeg');
...
CREATE TABLE `category_trees` (
  ...
  KEY `TREE_PARENT` (`PARENT_CATEGORY`),
  KEY `CATEGORY_TREES_INDEX` (`CAT_TREE_CODE`),
  CONSTRAINT `TREE_CHILD` FOREIGN KEY (`CHILD_CATEGORY`) REFERENCES `categories` (`CAT_CODE`),
  CONSTRAINT `TREE_PARENT` FOREIGN KEY (`PARENT_CATEGORY`) REFERENCES `categories` (`CAT_CODE`)
...
INSERT INTO `models` VALUES ('M0000000','Reserved',NULL,'I','N/A',NULL,NULL),('M00000001','Model One',NULL,'Y',NULL,'2019-07-12 14:49:16',NULL),('M00000002','Model Twoooooooooooooo',NULL,'R',NULL,'2019-07-12 14:51:19',NULL),('M00000003','Model Three',NULL,'I',NULL,'2019-07-12 14:50:56',NULL);
...
INSERT INTO `size_class_dets` VALUES ('Z01D00','Reserved','Z01','n/a'),('Z01D01','Size Cls 1 Det one','Z01',NULL),('Z01D02','Size Cls 1 Det two','Z01',NULL),('Z02D00','Reserved','Z02','n/a');
...
INSERT INTO `size_classes` VALUES ('Z00','Reserved','n/a',NULL),('Z01','Size Class One',NULL,'2019-07-16 20:08:51'),('Z02','Size Class Two',NULL,'2019-07-23 12:36:39');
...
INSERT INTO `sys_parameters` VALUES (1,NULL,NULL,NULL,'localhost','QQQzzz',NULL,NULL,NULL,NULL,NULL,'D:\\\\MyShop\\\\','NoImage.png');
...
-- Dump completed on 2019-08-11  1:02:30
