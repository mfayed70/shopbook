...
CREATE TABLE shopbook.CATEGORIES 
( 
...
, LAST_MODIFIED DATETIME NULL DEFAULT CURRENT_TIMESTAMP
, CAT_IMG_MA,E VARCHAR(200) NULL
, CAT_IMG_TYPE VARCHAR(10) NULL 
...
CREATE TABLE shopbook.CATEGORY_TREES 
( 
...
, PARENT_CATEGORY VARCHAR(5) NULL COMMENT 'UML to Offline Database Transform: Column TREE_PARENT created as default foreign key column for foreign key "TREE_PARENT"' 
, CAT_IMG_NAME VARCHAR(200) NULL COMMENT ''
, CAT_IMG_TYPE VARCHAR(10) NULL COMMENT ''
...
CREATE TABLE shopbook.CAT_MNF_BRND_MDL_YERS 
( 
...
CREATE TABLE shopbook.CAT_SIZE_CLASSES 
( 
...
CREATE TABLE shopbook.COUNTRIES 
( 
...
CREATE TABLE shopbook.CURRENCY_PRICES 
( 
...
CREATE TABLE shopbook.FAVOURITE_SHOPS 
( 
...
CREATE TABLE shopbook.LANGUAGES 
( 
...
CREATE TABLE shopbook.MANUFACTURES 
( 
...
CREATE TABLE shopbook.OFFER_DETS 
( 
...
, SKU_CLR_CODE VARCHAR(32) NULL COMMENT 'UML to Offline Database Transform: Column SKU_COLOR_TO_POST created as default foreign key column for foreign key "SKU_COLOR_TO_POST"' 
...
CREATE TABLE shopbook.SHOP_CATEGORIES 
( 
...
CREATE TABLE shopbook.SHOP_CATEGORY_ADMINS 
( 
...
CREATE TABLE shopbook.SHOP_DOCS 
( 
...
CREATE TABLE shopbook.SHOP_FEES_HISTS 
( 
...
CREATE TABLE shopbook.SHOP_IMAGESES 
( 
...
CREATE TABLE shopbook.SHOP_PROOF_DOC_TYPES 
( 
...
CREATE TABLE shopbook.SHOP_SKUS 
( 
...
CREATE TABLE shopbook.SHOP_SUB_CATS 
( 
...
CREATE TABLE shopbook.SHOP_SUB_CAT_PROP_CLASSES 
( 
...
CREATE TABLE shopbook.SHOP_SUB_CAT_PROP_CLASS_DETS 
( 
...
CREATE TABLE shopbook.SIZE_CLASSES 
( 
...
CREATE TABLE shopbook.SIZE_CLASS_DETS 
( 
...
CREATE TABLE shopbook.SIZE_CLASS_DET_PARAMS 
( 
...
CREATE TABLE shopbook.SIZ_CLASS_DET_PRM_VALS 
( 
...
CREATE TABLE shopbook.SKU_ASSEMBLIES 
( 
...
CREATE TABLE shopbook.SKU_COLORS 
( 
  SKU_CLR_CODE VARCHAR(32) NOT NULL COMMENT 'UML to Offline Database Transform: Column SKU_CLR_CODE created from UML attribute "sku clr code" in UML class "sku color"' 
...
CREATE TABLE shopbook.SKU_IMAGES 
( 
...
CREATE TABLE shopbook.SKU_PROP_DETS 
( 
...
CREATE TABLE shopbook.SKU_SIZES 
( 
...
CREATE TABLE shopbook.SKU_SIZE_COLORS 
( 
...
, SKU_CLR_CODE VARCHAR(32) NOT NULL COMMENT 'UML to Offline Database Transform: Column SKU_CLR_TO_SKU_SZ_CLR created as default foreign key column for foreign key "SKU_CLR_TO_SKU_SZ_CLR"' 
...
CREATE TABLE shopbook.SKU_SZ_CLR_IMAGES 
( 
  SKU_SZ_CLR_IMG_CODE VARCHAR(39) NOT NULL COMMENT 'UML to Offline Database Transform: Column SKU_SZ_CLR_IMG_CODE created from UML attribute "sku sz clr img code" in UML class "sku sz clr image"' 
, SKU_IMG_CODE VARCHAR(25) NOT NULL COMMENT 'UML to Offline Database Transform: Column SKU_IMGS_TO_SZ_CLR_IMGS created as default foreign key column for foreign key "SKU_IMGS_TO_SZ_CLR_IMGS"' 
, SKU_SZ_CLR_CODE VARCHAR(37) NOT NULL COMMENT 'UML to Offline Database Transform: Column SKU_SZ_CLR_TO_SKU_SZ_CLR_IMG created as default foreign key column for foreign key "SKU_SZ_CLR_TO_SKU_SZ_CLR_IMG"' 
...
, LAST_MODIFIED DATETIME NULL DEFAULT CURRENT_TIMESTAMP 
, CONSTRAINT PRIMARY KEY ( SKU_SZ_CLR_IMG_CODE ) ) 
COMMENT = 'UML to Offline Database Transform: Table SKU_SZ_CLR_IMAGES created from UML class "sku sz clr image"
UML to Offline Database Transform: Primary key constraint PRIMARY created by default
...
CREATE TABLE shopbook.SKU_UNITS 
( 
...
CREATE TABLE shopbook.SYS_PARAMETERS 
( 
...
, FILE_SERVER_PATH VARCHAR(200) NULL COMMENT 'UML to Offline Database Transform: Column FILE_SERVER_PATH created from UML attribute "file server path" in UML class "sys parameter"' 
...
CREATE TABLE shopbook.USERS_WISH_LISTS 
( 
...
ALTER TABLE shopbook.BRANDS ADD CONSTRAINT SHOP_REQ_NEW_BRANDS FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.CATEGORY_TREES ADD CONSTRAINT TREE_CHILD FOREIGN KEY ( CHILD_CATEGORY )
 REFERENCES shopbook.CATEGORIES ( CAT_CODE );

--ALTER TABLE shopbook.CATEGORY_TREES ADD CONSTRAINT TREE_PARENT FOREIGN KEY ( PARENT_CATEGORY )
-- REFERENCES shopbook.CATEGORIES ( CAT_CODE );

ALTER TABLE shopbook.CAT_MNF_BRND_MDL_YERS ADD CONSTRAINT BRAND_TO_CAT FOREIGN KEY ( BRAND_CODE )
 REFERENCES shopbook.BRANDS ( BRAND_CODE );

ALTER TABLE shopbook.CAT_MNF_BRND_MDL_YERS ADD CONSTRAINT CAT_MBMY FOREIGN KEY ( CAT_CODE )
 REFERENCES shopbook.CATEGORIES ( CAT_CODE );

ALTER TABLE shopbook.CAT_MNF_BRND_MDL_YERS ADD CONSTRAINT MANUFACTURE_TO_CAT FOREIGN KEY ( MNF_CODE )
 REFERENCES shopbook.MANUFACTURES ( MNF_CODE );

ALTER TABLE shopbook.CAT_MNF_BRND_MDL_YERS ADD CONSTRAINT MODEL_TO_CAT FOREIGN KEY ( MODEL_CODE )
 REFERENCES shopbook.MODELS ( MODEL_CODE );

ALTER TABLE shopbook.CAT_MNF_BRND_MDL_YERS ADD CONSTRAINT YEAR_TO_CAT FOREIGN KEY ( YEAR )
 REFERENCES shopbook.YEARS ( YEAR );

ALTER TABLE shopbook.CAT_SIZE_CLASSES ADD CONSTRAINT CAT_TO_CAT_SIZE_CLASS FOREIGN KEY ( CAT_CODE )
 REFERENCES shopbook.CATEGORIES ( CAT_CODE );

ALTER TABLE shopbook.CAT_SIZE_CLASSES ADD CONSTRAINT SIZE_CLS_TO_CAT_SIZE_CLASS FOREIGN KEY ( SZ_CLASS_CODE )
 REFERENCES shopbook.SIZE_CLASSES ( SZ_CLASS_CODE );

ALTER TABLE shopbook.CURRENCY_PRICES ADD CONSTRAINT FROM_CURR_TO_PRICES FOREIGN KEY ( FROM_CURR )
 REFERENCES shopbook.COUNTRIES ( CNTRY_CODE2 );

ALTER TABLE shopbook.CURRENCY_PRICES ADD CONSTRAINT TO_CURR_TO_PRICES FOREIGN KEY ( TO_CURR )
 REFERENCES shopbook.COUNTRIES ( CNTRY_CODE2 );

ALTER TABLE shopbook.FAVOURITE_SHOPS ADD CONSTRAINT SHOP_TO_FAVOURITE_SHOP FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.FAVOURITE_SHOPS ADD CONSTRAINT USER_FAVOURITE_SHOP FOREIGN KEY ( USER_ID )
 REFERENCES shopbook.USERS ( USER_ID );

ALTER TABLE shopbook.MANUFACTURES ADD CONSTRAINT SHOP_REQ_NEW_MANFS FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.MODELS ADD CONSTRAINT SHOP_REQ_NEW_MODELS FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.OFFERS ADD CONSTRAINT SHOP_OFFERS FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.OFFER_DETS ADD CONSTRAINT OFFERS_TO_OFFER_DET FOREIGN KEY ( OFFER_ID )
 REFERENCES shopbook.OFFERS ( SHP_CODE_OFFER_ID );

ALTER TABLE shopbook.OFFER_DETS ADD CONSTRAINT SKU_TO_OFFER_DET FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT POSTS_TREE FOREIGN KEY ( POST_CODE_PRNT )
 REFERENCES shopbook.POSTS ( POST_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT SHOP_POST FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT SKU_COLOR_TO_POST FOREIGN KEY ( SKU_CLR_CODE )
 REFERENCES shopbook.SKU_COLORS ( SKU_CLR_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT SKU_POST FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT SKU_SIZE_TO_POST FOREIGN KEY ( SKU_SIZE_CODE )
 REFERENCES shopbook.SKU_SIZES ( SKU_SIZE_CODE );

ALTER TABLE shopbook.POSTS ADD CONSTRAINT USER_POST FOREIGN KEY ( USER_ID )
 REFERENCES shopbook.USERS ( USER_ID );

ALTER TABLE shopbook.SHOPS ADD CONSTRAINT COUNTRY_SHOP FOREIGN KEY ( CNTRY_CODE2 )
 REFERENCES shopbook.COUNTRIES ( CNTRY_CODE2 );

ALTER TABLE shopbook.SHOPS ADD CONSTRAINT SHOP_BRANCH FOREIGN KEY ( PARENT_SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_CATEGORIES ADD CONSTRAINT CATEGORY_TO_SHOP FOREIGN KEY ( CAT_CODE )
 REFERENCES shopbook.CATEGORIES ( CAT_CODE );

ALTER TABLE shopbook.SHOP_CATEGORIES ADD CONSTRAINT SHOP_TO_CATEGORY FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_CATEGORY_ADMINS ADD CONSTRAINT ADMIN_TO_ADMIN_CAT FOREIGN KEY ( USER_ID )
 REFERENCES shopbook.USERS ( USER_ID );

ALTER TABLE shopbook.SHOP_CATEGORY_ADMINS ADD CONSTRAINT SHOP_CATS_TO_ADMIN_CAT FOREIGN KEY ( SHOP_CAT_SUB_CODE )
 REFERENCES shopbook.SHOP_SUB_CATS ( SHOP_SUB_CAT_CODE );

ALTER TABLE shopbook.SHOP_DOCS ADD CONSTRAINT DOC_TYPE_TO_PROOF_DOC FOREIGN KEY ( CNTRY_DOC_TYPE )
 REFERENCES shopbook.SHOP_PROOF_DOC_TYPES ( CNTRY_DOC_TYPE );

ALTER TABLE shopbook.SHOP_DOCS ADD CONSTRAINT SHOP_TO_PROOF_DOCS FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_FEES_HISTS ADD CONSTRAINT SHOP_TO_FEES_HIST FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_IMAGESES ADD CONSTRAINT SHOP_TO_SHOP_IMAGES FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_PROOF_DOC_TYPES ADD CONSTRAINT CNTRY_TO_DOC_TYPE FOREIGN KEY ( CNTRY_CODE2 )
 REFERENCES shopbook.COUNTRIES ( CNTRY_CODE2 );

ALTER TABLE shopbook.SHOP_PROOF_DOC_TYPES ADD CONSTRAINT LANG_TO_SHOP_PROOF_DOC_TYPE FOREIGN KEY ( LANG_CODE )
 REFERENCES shopbook.LANGUAGES ( LANG_CODE );

ALTER TABLE shopbook.SHOP_SKUS ADD CONSTRAINT SHOP_BRANCH_TO_SKU FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.SHOP_SKUS ADD CONSTRAINT SHOP_TO_SKU_SZ_CLR FOREIGN KEY ( SKU_SZ_CLR_CODE )
 REFERENCES shopbook.SKU_SIZE_COLORS ( SKU_SZ_CLR_CODE );

ALTER TABLE shopbook.SHOP_SUB_CATS ADD CONSTRAINT SHOP_CAT_TO_SUB_CAT FOREIGN KEY ( SHOP_CAT_CODE )
 REFERENCES shopbook.SHOP_CATEGORIES ( SHOP_CAT_CODE );

ALTER TABLE shopbook.SHOP_SUB_CAT_PROP_CLASSES ADD CONSTRAINT SHOP_CAT_PROP_CLASS FOREIGN KEY ( SHOP_SUB_CAT_CODE )
 REFERENCES shopbook.SHOP_SUB_CATS ( SHOP_SUB_CAT_CODE );

ALTER TABLE shopbook.SHOP_SUB_CAT_PROP_CLASS_DETS ADD CONSTRAINT PROP_CLSS_TO_DET FOREIGN KEY ( PROP_CLASS_CODE )
 REFERENCES shopbook.SHOP_SUB_CAT_PROP_CLASSES ( SHP_SUB_CAT_PRP_CLS_CODE );

ALTER TABLE shopbook.SIZE_CLASS_DETS ADD CONSTRAINT SIZE_TO_SIZE_DET FOREIGN KEY ( SZ_CLASS_CODE )
 REFERENCES shopbook.SIZE_CLASSES ( SZ_CLASS_CODE );

ALTER TABLE shopbook.SIZE_CLASS_DET_PARAMS ADD CONSTRAINT SIZE_CLASS_PARAM FOREIGN KEY ( SZ_CLASS_CODE )
 REFERENCES shopbook.SIZE_CLASSES ( SZ_CLASS_CODE );

ALTER TABLE shopbook.SIZ_CLASS_DET_PRM_VALS ADD CONSTRAINT DET_PARAM_VAL FOREIGN KEY ( SZ_DET_PRM_CODE )
 REFERENCES shopbook.SIZE_CLASS_DET_PARAMS ( SZ_DET_PRM_CODE );

ALTER TABLE shopbook.SIZ_CLASS_DET_PRM_VALS ADD CONSTRAINT SZ_CLASS_DET_PRM_VAL FOREIGN KEY ( SZ_DET_CODE )
 REFERENCES shopbook.SIZE_CLASS_DETS ( SZ_DET_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SHOPCAT_SKU FOREIGN KEY ( SHOP_CAT_SUB_CODE )
 REFERENCES shopbook.SHOP_SUB_CATS ( SHOP_SUB_CAT_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SHP_CAT_PROP_CLS_TO_SHU FOREIGN KEY ( SHP_PROP_CLS_CODE )
 REFERENCES shopbook.SHOP_SUB_CAT_PROP_CLASSES ( SHP_SUB_CAT_PRP_CLS_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SKU_BRAND FOREIGN KEY ( BRAND_CODE )
 REFERENCES shopbook.BRANDS ( BRAND_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SKU_MANUFACTURER FOREIGN KEY ( MNF_CODE )
 REFERENCES shopbook.MANUFACTURES ( MNF_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SKU_MODEL FOREIGN KEY ( MODEL_CODE )
 REFERENCES shopbook.MODELS ( MODEL_CODE );

ALTER TABLE shopbook.SKUS ADD CONSTRAINT SKU_YEAR FOREIGN KEY ( YEAR )
 REFERENCES shopbook.YEARS ( YEAR );

ALTER TABLE shopbook.SKU_ASSEMBLIES ADD CONSTRAINT MAIN_SKU_TO_ASSEMBLY FOREIGN KEY ( SKU_ASS_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_ASSEMBLIES ADD CONSTRAINT SKU_TO_ASS_COMP FOREIGN KEY ( SKU_ASS_COMP )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_COLORS ADD CONSTRAINT SKU_TO_COLORS FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_IMAGES ADD CONSTRAINT SKU_TO_SKU_IMAGE FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_PROP_DETS ADD CONSTRAINT PROP_DET_TO_ITEM_DET FOREIGN KEY ( SHP_SUBCAT_PRP_CLS_DET_CODE )
 REFERENCES shopbook.SHOP_SUB_CAT_PROP_CLASS_DETS ( SHP_SUBCAT_PRP_CLS_DET_CODE );

ALTER TABLE shopbook.SKU_PROP_DETS ADD CONSTRAINT SKU_TO_SKU_PROP FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_SIZES ADD CONSTRAINT SKU_TO_SKU_SIZES FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_SIZES ADD CONSTRAINT SZ_CLS_DET_TO_SKU_SZS FOREIGN KEY ( SIZE_DET_CODE )
 REFERENCES shopbook.SIZE_CLASS_DETS ( SZ_DET_CODE );

ALTER TABLE shopbook.SKU_SIZE_COLORS ADD CONSTRAINT SKU_CLR_TO_SKU_SZ_CLR FOREIGN KEY ( SKU_CLR_CODE )
 REFERENCES shopbook.SKU_COLORS ( SKU_CLR_CODE );

ALTER TABLE shopbook.SKU_SIZE_COLORS ADD CONSTRAINT SKU_SZ_TO_SKU_SZ_CLR FOREIGN KEY ( SKU_SIZE_CODE )
 REFERENCES shopbook.SKU_SIZES ( SKU_SIZE_CODE );

ALTER TABLE shopbook.SKU_SZ_CLR_IMAGES ADD CONSTRAINT SKU_IMGS_TO_SZ_CLR_IMGS FOREIGN KEY ( SKU_IMG_CODE )
 REFERENCES shopbook.SKU_IMAGES ( SKU_IMG_CODE );

ALTER TABLE shopbook.SKU_SZ_CLR_IMAGES ADD CONSTRAINT SKU_SZ_CLR_TO_SKU_SZ_CLR_IMG FOREIGN KEY ( SKU_SZ_CLR_CODE )
 REFERENCES shopbook.SKU_SIZE_COLORS ( SKU_SZ_CLR_CODE );

ALTER TABLE shopbook.SKU_UNITS ADD CONSTRAINT SKU_TO_SKU_UNIT FOREIGN KEY ( SKU_CODE )
 REFERENCES shopbook.SKUS ( SKU_CODE );

ALTER TABLE shopbook.SKU_UNITS ADD CONSTRAINT UNIT_TO_SKU_UNIT FOREIGN KEY ( UNIT_CODE )
 REFERENCES shopbook.UNITS ( FROM_UNIT );

ALTER TABLE shopbook.SYS_PARAMETERS ADD CONSTRAINT SHOP_TO_SYS_PRM FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE SYS_IMAGES ADD CONSTRAINT SYS_IMAGES FOREIGN KEY ( SYS_PARAMETER_ID )
 REFERENCES SYS_PARAMETERS ( SYS_PARAMETER_ID );

ALTER TABLE shopbook.UNITS ADD CONSTRAINT UNITS_TREE FOREIGN KEY ( TO_UNIT )
 REFERENCES shopbook.UNITS ( FROM_UNIT );

ALTER TABLE shopbook.USERS ADD CONSTRAINT SHOP_TO_SHOP_ADMIN FOREIGN KEY ( SHOP_CODE )
 REFERENCES shopbook.SHOPS ( SHOP_CODE );

ALTER TABLE shopbook.USERS_WISH_LISTS ADD CONSTRAINT SKU_TO_SZ_CLR_WISH_LISTS FOREIGN KEY ( SKU_SZ_CLR_CODE )
 REFERENCES shopbook.SKU_SIZE_COLORS ( SKU_SZ_CLR_CODE );

ALTER TABLE shopbook.USERS_WISH_LISTS ADD CONSTRAINT USER_WISH_ITEMS FOREIGN KEY ( USER_ID )
 REFERENCES shopbook.USERS ( USER_ID );
...
CREATE INDEX BRANDS_INDEX ON shopbook.BRANDS ( BRAND_CODE);

CREATE INDEX CATEGORIES_INDEX ON shopbook.CATEGORIES ( CAT_CODE);

CREATE INDEX CATEGORY_TREES_INDEX ON shopbook.CATEGORY_TREES ( CAT_TREE_CODE);

CREATE INDEX CAT_MNF_BRND_MDL_YERS_INDEX ON shopbook.CAT_MNF_BRND_MDL_YERS ( CMBMY_CODE);

CREATE INDEX CAT_SIZE_CLASSES_INDEX ON shopbook.CAT_SIZE_CLASSES ( CAT_SZ_CLASS_CODE);

CREATE INDEX COUNTRIES_INDEX ON shopbook.COUNTRIES ( CNTRY_CODE2);

CREATE INDEX LANGUAGES_INDEX ON shopbook.LANGUAGES ( LANG_CODE);

CREATE INDEX MANUFACTURES_INDEX ON shopbook.MANUFACTURES ( MNF_CODE);

CREATE INDEX MODELS_INDEX ON shopbook.MODELS ( MODEL_CODE);

CREATE INDEX OFFERS_INDEX ON shopbook.OFFERS ( SHP_CODE_OFFER_ID);

CREATE INDEX OFFER_DETS_INDEX ON shopbook.OFFER_DETS ( OFFER_DET_ID);

CREATE INDEX POSTS_INDEX ON shopbook.POSTS ( POST_CODE);

CREATE INDEX SHOPS_INDEX ON shopbook.SHOPS ( SHOP_CODE);

CREATE INDEX SHOP_CATEGORIES_INDEX ON shopbook.SHOP_CATEGORIES ( SHOP_CAT_CODE);

CREATE INDEX SHOP_CATEGORY_ADMINS_INDEX ON shopbook.SHOP_CATEGORY_ADMINS ( ADMIN_SHP_CAT_CODE);

CREATE INDEX SHOP_DOCS_INDEX ON shopbook.SHOP_DOCS ( SHOP_DOC_CODE);

CREATE INDEX SHOP_FEES_HISTS_INDEX ON shopbook.SHOP_FEES_HISTS ( TRANS_CODE);

CREATE INDEX SHOP_PROOF_DOC_TYPES_INDEX ON shopbook.SHOP_PROOF_DOC_TYPES ( CNTRY_DOC_TYPE ASC);

CREATE INDEX SHOP_SKUS_INDEX ON shopbook.SHOP_SKUS ( SHOP_SKU_CODE);

CREATE INDEX SHOP_SUB_CATS_INDEX ON shopbook.SHOP_SUB_CATS ( SHOP_SUB_CAT_CODE);

CREATE INDEX SHOP_SUB_CAT_PROP_CLASSES_INDEX ON shopbook.SHOP_SUB_CAT_PROP_CLASSES ( SHP_SUB_CAT_PRP_CLS_CODE);

CREATE INDEX SHOP_SUB_CAT_PROP_CLASS_DETS_INDEX ON shopbook.SHOP_SUB_CAT_PROP_CLASS_DETS ( SHP_SUBCAT_PRP_CLS_DET_CODE);

CREATE INDEX SIZE_CLASSES_INDEX ON shopbook.SIZE_CLASSES ( SZ_CLASS_CODE ASC);

CREATE INDEX SIZE_CLASS_DETS_INDEX ON shopbook.SIZE_CLASS_DETS ( SZ_DET_CODE);

CREATE INDEX SIZE_CLASS_DET_PARAMS_INDEX ON shopbook.SIZE_CLASS_DET_PARAMS ( SZ_DET_PRM_CODE);

CREATE INDEX SIZ_CLASS_DET_PRM_VALS_INDEX ON shopbook.SIZ_CLASS_DET_PRM_VALS ( SZ_DET_PRM_VAL_CODE);

CREATE INDEX SKUS_INDEX ON shopbook.SKUS ( SKU_CODE);

CREATE INDEX SKU_COLORS_INDEX ON shopbook.SKU_COLORS ( SKU_CLR_CODE);

CREATE INDEX SKU_IMAGES_INDEX ON shopbook.SKU_IMAGES ( SKU_IMG_CODE);

CREATE INDEX SKU_PROP_DETS_INDEX ON shopbook.SKU_PROP_DETS ( SKU_PROP_DET_CODE);

CREATE INDEX SKU_SIZES_INDEX ON shopbook.SKU_SIZES ( SKU_SIZE_CODE);

CREATE INDEX SKU_SIZE_COLORS_INDEX ON shopbook.SKU_SIZE_COLORS ( SKU_SZ_CLR_CODE);

CREATE INDEX SKU_SZ_CLR_IMAGES_INDEX ON shopbook.SKU_SZ_CLR_IMAGES ( SKU_SZ_CLR_IMG_CODE);

CREATE INDEX SKU_UNITS_INDEX ON shopbook.SKU_UNITS ( SKU_UNIT_CODE);

CREATE INDEX SYS_PARAMETERS_INDEX ON shopbook.SYS_PARAMETERS ( SYS_PARAMETER_ID);

CREATE INDEX UNITS_INDEX ON shopbook.UNITS ( FROM_UNIT);

CREATE INDEX USERS_INDEX ON shopbook.USERS ( USER_ID);

CREATE INDEX YEARS_INDEX ON shopbook.YEARS ( YEAR);
