...
public class ADFUtils{
    ...
    public static DCIteratorBinding findIterator(String bindingContainer, String iterator) {
        DCBindingContainer bindings = 
            (DCBindingContainer)JSFUtil.resolveExpression("#{" + bindingContainer + "}");
        if (bindings == null) {
    ...
    public static OperationBinding findOperation(String bindingContianer, 
                                                 String opName) {
        DCBindingContainer bindings = 
            (DCBindingContainer)JSFUtil.resolveExpression("#{" + bindingContianer + "}");
        if (bindings == null) {
            throw new RuntimeException("Binding container '" + 
 ...
 */   
                                 ...
                                 String alignId)
  {
    if (popupId != null)
    {
      ...
      showPopup.append("var popupObj=AdfPage.PAGE.findComponent('" +
                       popupId + "'); if (popupObj) popupObj.show(hints);");
  ...
  public static void hidePopup(String popupId)
  {
    ...
    public static void raiseContextualEvent(String eventBindingOpExpr,ActionEvent  actionEvent,Map<String,Object> payload) 
    {
    ...
    public static void makeCurrentRowInTable(SelectionEvent selectionEvent){
        ...
        adfTableBinding = (JUCtrlHierBinding) 
                    ((CollectionModel)table.getValue()).getWrappedData();
